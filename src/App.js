...
import iconCross from "./assests/images/cross.svg";
...
function AllInputs({
  ...
  return (
    <div>
      ...
      <div
        className={`flex mt-0 p-2 md:rounded-b-md ${
          isDarkMode
      ...
      <div
        className={`flex md:hidden mt-2 justify-around p-2 rounded-b-md ${
          isDarkMode
            ? "bg-white border-b border-t border-gray-300 text-black"
            : "bg-veryDarkDesaturatedBlue border-t border-veryDarkGrayishBlueDark text-veryDarkGrayishBlueDark"
        }`}
      >
        <span
          onClick={() => setFilter("all")}
